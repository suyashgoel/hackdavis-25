...
import animationData from "@/assets/voice-talking.json";
...
export default function Home() {
  ...
  const [enabled, setEnabled] = useState(true); // Your toggle flag
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen">
      ...
      src="/Numaframe1.png"
      alt="Numaframe"
      className="z-10 mb-4 w-140 object-contain" // Adjusted width to 48
      />
